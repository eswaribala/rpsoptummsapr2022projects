package com.optum.apigateway.filters;
...
import com.optum.apigateway.dtos.JwtRequest;
import com.optum.apigateway.dtos.JwtResponse;
	...
	"userPwd":"test@123"
	     ...
	     */
 	    ...
 	    ResponseEntity<?> authResponse=restTemplate.
 		      postForEntity(authUrl+api,request, String.class);
		 ...
		 ResponseEntity<String> responseEntityStr = restTemplate.
          exchange(authUrl+role,HttpMethod.GET, request,
		  String.class); 
