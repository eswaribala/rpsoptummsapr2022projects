package com.optum.policyholderapi.configurations;
...
import com.optum.policyholderapi.exceptions.JwtTokenMalformedException;
import com.optum.policyholderapi.exceptions.JwtTokenMissingException;
...
public class JwtUtil {
	...
	public String generateToken(User user) {
		...
		return Jwts.builder().setClaims(claims).setIssuedAt(new Date(nowMillis))
				.setExpiration(exp)
				.signWith(SignatureAlgorithm.HS512, vaultConfiguration.getKey())
				.compact();
	}
